...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20231218075705_addSearchConsoleTables")]
    partial class addSearchConsoleTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.SearchConsoleKeyword", b =>
                {
                    ...
                    b.Property<int?>("SearchConsoleUrlId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SearchConsoleUrlId")
                        .IsUnique()
                        .HasFilter("[SearchConsoleUrlId] IS NOT NULL");

                    b.ToTable("SearchConsoleKeywords");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.SearchConsoleKeywordRank", b =>
                {
                    ...
                    b.ToTable("SearchConsoleKeywordRanks");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.SearchConsoleKeyword", b =>
                {
                    b.HasOne("DataAccessLayer.Entites.SearchConsoleDate", "SearchConsoleDate")
                        .WithMany("SearchConsoleKeywords")
                        .HasForeignKey("SearchConsoleDateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Entites.SearchConsoleUrl", "SearchConsoleUrl")
                        .WithOne("SearchConsoleKeyword")
                        .HasForeignKey("DataAccessLayer.Entites.SearchConsoleKeyword", "SearchConsoleUrlId");
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.SearchConsoleDate", b =>
                {
                    b.Navigation("SearchConsoleKeywords");
                });
