...
namespace DataAccessLayer.Migrations
{
    ...
    partial class SeoToolDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.CompetitorsSummery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CompetitorsSummeries");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.ExcelExport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.KeywordInView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.View", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.KeywordInView", b =>
                {
                    b.HasOne("DataAccessLayer.Entites.Keyword", "Keywords")
                        .WithMany("KeywordInView")
                        .HasForeignKey("KeywordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Entites.View", "Views")
                        .WithMany("KeywordInViews")
            ...
            modelBuilder.Entity("DataAccessLayer.Entites.Site", b =>
                {
                    b.Navigation("CompetitorsSummeries");
